...
> **ARCHIVED — DO NOT USE FOR THE CURRENT RUN.** This guide belongs to the former YOLOv8/Android workflow and contains an obsolete dataset/class setup. The active 63-class YOLO26s workflow is in `docs/roboflow_training_guide.md` and `training/train_colab.py`.
